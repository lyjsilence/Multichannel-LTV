...
def main() -> None:
    ...
    parser.add_argument('--save_dirs', type=str, default='results_payment_level_auxiliary_stat_103700030')

    parser.add_argument('--target_company_id', type=int, default=103700030,
